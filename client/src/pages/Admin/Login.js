...
function Login() {
  ...
  return (
    <div className='flex justify-center items-center h-screen bg-primary'>
        <div className='w-96 flex gap-5 p-5 shadow border border-gray-500 flex-col bg-tertiary'>
        ...
        <button className='bg-secondary text-primary p-2' onClick={login}>Login</button>
        </div>
    </div>
  )
}
